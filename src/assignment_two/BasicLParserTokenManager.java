package assignment_two;/* BasicLParserTokenManager.java */
/* Generated By:JJTree&JavaCC: Do not edit this line. BasicLParserTokenManager.java */
import java.io.*;
import java.util.*;

/** Token Manager. */
@SuppressWarnings("unused")public class BasicLParserTokenManager implements BasicLParserConstants {
...
private static final int jjStopStringLiteralDfa_0(int pos, long active0){
   switch (pos)
   {
      ...
      case 1:
         ...
         return -1;
      case 2:
         if ((active0 & 0x885020000000L) != 0L)
            return 8;
         if ((active0 & 0x7726c0000000L) != 0L)
         {
            jjmatchedKind = 49;
            jjmatchedPos = 2;
            return 8;
         ...
         return -1;
      case 3:
         if ((active0 & 0x162240000000L) != 0L)
            return 8;
         if ((active0 & 0x610480000000L) != 0L)
         {
            jjmatchedKind = 49;
            jjmatchedPos = 3;
            return 8;
...
static private int jjMoveStringLiteralDfa1_0(long active0){
   ...
   switch(curChar)
   {
      ...
      case 61:
         ...
         break;
      case 97:
         return jjMoveStringLiteralDfa2_0(active0, 0x82400000000L);
      case 101:
      ...
      case 110:
         return jjMoveStringLiteralDfa2_0(active0, 0x801020000000L);
      case 111:
         if ((active0 & 0x100000000L) != 0L)
            return jjStartNfaWithStates_0(1, 32, 8);
         return jjMoveStringLiteralDfa2_0(active0, 0x1040c0000000L);
      case 114:
...
static private int jjMoveStringLiteralDfa2_0(long old0, long active0){
   ...
   switch(curChar)
   {
      ...
      case 105:
         return jjMoveStringLiteralDfa3_0(active0, 0x302000000000L);
      case 108:
...
"\73", "\72", "\72\75", "\173", "\175", "\141\156\144", "\142\157\157\154", 
"\143\157\156\163\164", "\144\157", "\145\154\163\145", "\146\141\154\163\145", "\151\146", 
"\151\156\164", "\155\141\151\156", "\156\157\164", "\157\162", "\162\145\164\165\162\156", 
"\164\150\145\156", "\164\162\165\145", "\166\141\162", "\166\157\151\144", 
"\167\150\151\154\145", "\142\145\147\151\156", "\145\156\144", null, null, null, null, null, null, };
...
static private void jjCheckNAddStates(int start, int end)
{
   do {
    ...
    /** Constructor. */
    public BasicLParserTokenManager(SimpleCharStream stream){
  ...
  /** Constructor. */
  public BasicLParserTokenManager (SimpleCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
